...
app.controller("DepocitoController", ['$scope','$http','$location',function($scope,$http,$location){
    ...
    $scope.retirarSaldo = function() {
        ...
        if (monto > 9000) {
            alert("no se pude hacer depositor mallores a $9000.");
            return;
        }
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="card text-center" style="padding: 20px;">
                                    ...
                                    <h3 class="menu">Ticket Deposito</h3>
...
app.controller("TicketDController", ['$scope', '$http', '$location', function($scope, $http, $location) {
    $scope.id = $location.search().id;
